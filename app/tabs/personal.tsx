...
import { filterNotesByCategory, searchNotes } from '../../utils/searchHelpers';
...
export default function PersonalNotesScreen() {
  ...
  const filteredNotes = useMemo(() => {
    let result = filterNotesByCategory(notes, 'Personal');
  ...
  const handleSaveNote = async (noteData: any) => {
    try {
      if (editingNote) {
        ...
        await addNote({ ...noteData, category: 'Personal' });
      }
